    ...
    <div className="mt-5">
      ...
      <div className="mt-5 flex items-center gap-3">
        <button
          type="button"
          onClick={onBack}
          className="rounded-full border border-surfaceGlass/10 px-4 py-2 text-[13px] text-textSecondary hover:border-surfaceGlass/20"
        >
          {copy.reparse}
        </button>
        <button
          ...
          return (
            <div
              ...
              className={[
                ...
                row.match === 'MISSING_INFO' ? 'border-ember/40' : 'border-surfaceGlass/10',
                included ? '' : 'opacity-60',
              ].join(' ')}
            >
    ...
    <div className="mt-6 flex flex-col items-center gap-4 rounded-card border border-surfaceGlass/10 bg-bgSecondary px-6 py-10 text-center">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3">
        <button
          type="button"
          onClick={onReset}
          className="rounded-full border border-surfaceGlass/10 px-5 py-2 text-[13px] text-textSecondary hover:border-surfaceGlass/20"
        >
          {copy.startOver}
        </button>
        <Link
