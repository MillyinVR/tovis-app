// app/api/looks/[id]/comments/[commentId]/replies/route.test.ts
...
function req() {
  return new Request(
    'http://localhost/api/looks/look_1/comments/comment_1/replies',
  )
}

describe('app/api/looks/[id]/comments/[commentId]/replies/route.ts GET', () => {
  beforeEach(() => {
    vi.clearAllMocks()
