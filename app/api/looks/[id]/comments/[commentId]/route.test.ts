// app/api/looks/[id]/comments/[commentId]/route.test.ts
...
function req() {
  return new Request('http://localhost/api/looks/look_1/comments/comment_1', {
    method: 'DELETE',
  })
}

describe('app/api/looks/[id]/comments/[commentId]/route.ts DELETE', () => {
  beforeEach(() => {
    vi.clearAllMocks()
