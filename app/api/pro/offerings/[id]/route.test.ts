// app/api/pro/offerings/[id]/route.test.ts
...
function makeRequest(body: unknown): Request {
  return new Request('http://localhost/api/pro/offerings/offering_1', {
    method: 'PATCH',
    headers: {
...
describe('app/api/pro/offerings/[id]/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('PATCH', () => {
    ...
    it('returns 500 when PATCH throws unexpectedly', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'PATCH /api/pro/offerings/[id] error',
        expect.any(Error),
      )
  ...
  describe('DELETE', () => {
    ...
    it('returns 500 when DELETE throws unexpectedly', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'DELETE /api/pro/offerings/[id] error',
        expect.any(Error),
      )
