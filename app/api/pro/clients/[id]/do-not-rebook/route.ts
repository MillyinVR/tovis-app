// app/api/pro/clients/[id]/do-not-rebook/route.ts
//
...
export async function PUT(req: Request, context: RouteContext) {
  try {
    ...
    console.error('PUT /api/pro/clients/[id]/do-not-rebook error', e)
...
export async function DELETE(_req: Request, context: RouteContext) {
  try {
    ...
    console.error('DELETE /api/pro/clients/[id]/do-not-rebook error', e)
