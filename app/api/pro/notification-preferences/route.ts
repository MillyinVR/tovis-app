// app/api/pro/notification-preferences/route.ts
...
export async function GET() {
  try {
    ...
    console.error('GET /api/pro/notification-preferences error', error)
...
export async function PATCH(req: Request) {
  try {
    ...
    console.error('PATCH /api/pro/notification-preferences error', error)
