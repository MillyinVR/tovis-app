...
function makeJsonRequest(body: unknown): Request {
  return new Request('http://localhost/api/pro/media/media_1', {
    method: 'PATCH',
    headers: {
...
describe('app/api/pro/media/[id]/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
