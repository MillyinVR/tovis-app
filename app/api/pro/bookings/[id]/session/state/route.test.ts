// app/api/pro/bookings/[id]/session/state/route.test.ts
...
function makeRequest(): Request {
  return new Request(
    'http://localhost/api/pro/bookings/booking_1/session/state',
    { method: 'GET' },
  )
}
...
describe('GET /api/pro/bookings/[id]/session/state', () => {
