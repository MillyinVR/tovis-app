// app/api/pro/availability/busy-days/route.ts
//
...
// blocked?"). Unlike /api/availability/* (client-facing, per-service slot
...
export async function GET(req: Request) {
  try {
    ...
    console.error('GET /api/pro/availability/busy-days error', error)
