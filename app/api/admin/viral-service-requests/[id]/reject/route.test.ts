...
describe('app/api/admin/viral-service-requests/[id]/reject/route.ts', () => {
  ...
  it('delegates POST to the shared legacy viral moderation handler with forced reject action and route id', async () => {
    ...
    const req = makeJsonRequest({ adminNotes: 'Not a fit right now.' })
