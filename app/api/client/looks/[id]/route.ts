// app/api/client/looks/[id]/route.ts
//
// Per-look visibility toggle for client-authored looks (Public on profile vs
// Save-to-profile-only). Client mirror of PATCH /api/pro/looks/[id].
...
export async function PATCH(req: Request, ctx: RouteContext) {
  try {
    ...
    console.error('PATCH /api/client/looks/[id] error', { error: safeError(error) })
