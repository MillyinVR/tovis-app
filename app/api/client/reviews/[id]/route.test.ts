// app/api/client/reviews/[id]/route.test.ts
...
function makePatchRequest(body: unknown): NextRequest {
  return new NextRequest('http://localhost/api/client/reviews/review_1', {
    method: 'PATCH',
    headers: {
      'content-type': 'application/json',
    },
...
describe('app/api/client/reviews/[id]/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('PATCH', () => {
    ...
    it('returns 500 and logs a safe error when update throws', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'PATCH /api/client/reviews/[id] error',
        {
          error: {
            name: 'Error',
  ...
  describe('DELETE', () => {
    ...
    it('returns 500 and logs a safe error when delete throws', async () => {
      ...
      expect(mocks.safeError).toHaveBeenCalledWith(thrown)
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'DELETE /api/client/reviews/[id] error',
        {
          error: {
            name: 'Error',
