// app/api/client/rebook/[token]/checkout/route.ts
//
...
// /api/client/bookings/[id]/checkout/stripe-session route but resolves the
...
const ROUTE_OPERATION = 'POST /api/client/rebook/[token]/checkout'
