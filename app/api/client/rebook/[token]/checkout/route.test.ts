// app/api/client/rebook/[token]/checkout/route.test.ts
...
function makeReq(body: unknown = {}) {
  return new Request('http://localhost/api/client/rebook/token_1/checkout', {
    method: 'POST',
...
describe('POST /api/client/rebook/[token]/checkout', () => {
