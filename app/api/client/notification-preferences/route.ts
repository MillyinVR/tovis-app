// app/api/client/notification-preferences/route.ts
...
export async function GET() {
  try {
    ...
    console.error('GET /api/client/notification-preferences error', error)
...
export async function PATCH(req: Request) {
  try {
    ...
    console.error('PATCH /api/client/notification-preferences error', error)
