// app/api/client/bookings/[id]/aftercare-rebook/route.test.ts
...
function makeRequest(args?: { body?: unknown; headers?: HeadersInit }): Request {
  return new Request(
    'http://localhost/api/client/bookings/booking_1/aftercare-rebook',
    {
      method: 'POST',
...
describe('app/api/client/bookings/[id]/aftercare-rebook/route.ts', () => {
