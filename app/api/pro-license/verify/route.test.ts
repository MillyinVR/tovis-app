// app/api/pro-license/verify/route.test.ts
...
function makeReq(body: unknown) {
  return new Request('http://localhost/api/pro-license/verify', {
    method: 'POST',
...
describe('POST /api/pro-license/verify — auth + throttle gates', () => {
