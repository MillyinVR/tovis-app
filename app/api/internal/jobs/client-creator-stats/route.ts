...
//
// Refreshes ClientCreatorStat — a client-creator's saves percentile and tier,
// shown as "✦ Tastemaker · top 5% saver" on the public profile
...
async function runJob(req: Request) {
  ...
  try {
    const result = await refreshClientCreatorStats(prisma, new Date())
