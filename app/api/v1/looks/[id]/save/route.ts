// app/api/v1/looks/[id]/save/route.ts
...
export async function GET(_req: Request, ctx: RouteContext) {
  try {
    ...
    console.error('GET /api/v1/looks/[id]/save error', error)
...
export async function POST(req: Request, ctx: RouteContext) {
  try {
    ...
    console.error('POST /api/v1/looks/[id]/save error', error)
...
export async function DELETE(req: Request, ctx: RouteContext) {
  try {
    ...
    console.error('DELETE /api/v1/looks/[id]/save error', error)
    return jsonFail(500, 'Couldn’t update save state. Try again.', {
      code: 'INTERNAL',
    })
  }
