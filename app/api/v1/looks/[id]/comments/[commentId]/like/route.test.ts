// app/api/v1/looks/[id]/comments/[commentId]/like/route.test.ts
...
function req(method: string) {
  return new Request('http://localhost/api/v1/looks/look_1/comments/comment_1/like', {
    method,
  })
}

describe('app/api/v1/looks/[id]/comments/[commentId]/like/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
