// app/api/v1/looks/[id]/comments/[commentId]/like/route.ts
...
export async function POST(_req: Request, ctx: CommentLikeContext) {
  try {
    ...
    console.error('POST /api/v1/looks/[id]/comments/[commentId]/like error', e)
...
export async function DELETE(_req: Request, ctx: CommentLikeContext) {
  try {
    ...
    console.error('DELETE /api/v1/looks/[id]/comments/[commentId]/like error', e)
    return jsonFail(500, 'Couldn’t update your like. Try again.', {
      code: 'INTERNAL',
    })
  }
