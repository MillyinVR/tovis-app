// app/api/v1/pros/[id]/follow/route.ts
...
export async function GET(_req: Request, ctx: RouteContext) {
  try {
    ...
    console.error('GET /api/v1/pros/[id]/follow error', error)
  ...
  try {
    ...
    if (state.following) {
      ...
      await createLookFollowerNewProNotification({
        ...
        console.error('POST /api/v1/pros/[id]/follow notify error', error)
      })
    ...
    console.error('POST /api/v1/pros/[id]/follow error', error)
