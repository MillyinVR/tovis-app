// app/api/v1/pro/migrate/calendar/subscription/route.ts
//
...
export async function POST(request: Request) {
  try {
    ...
    console.error('POST /api/v1/pro/migrate/calendar/subscription error', error)
...
export async function DELETE() {
  try {
    ...
    console.error('DELETE /api/v1/pro/migrate/calendar/subscription error', error)
    return jsonFail(500, 'Internal server error')
  }
}
