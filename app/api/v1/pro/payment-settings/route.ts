...
export async function GET() {
  try {
    ...
    console.error('GET /api/v1/pro/payment-settings error', e)
...
export async function PATCH(req: Request) {
  try {
    ...
    try {
      ...
      console.error('PATCH /api/v1/pro/payment-settings prisma error', e)
      return jsonFail(500, 'Failed to update payment settings.', {
        message: e instanceof Error ? e.message : String(e),
      })
    }
  } catch (e: unknown) {
    console.error('PATCH /api/v1/pro/payment-settings error', e)
    return jsonFail(500, 'Failed to update payment settings.', {
      message: e instanceof Error ? e.message : String(e),
    })
  }
