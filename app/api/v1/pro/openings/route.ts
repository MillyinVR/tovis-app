// app/api/v1/pro/openings/route.ts
...
export async function GET(req: Request) {
  try {
    ...
    console.error('GET /api/v1/pro/openings error', e)
...
export async function POST(req: Request) {
  try {
    ...
    console.error('POST /api/v1/pro/openings error', e)
...
export async function DELETE(req: Request) {
  try {
    ...
    console.error('DELETE /api/v1/pro/openings error', e)
