...
describe('POST /api/v1/pro/booking-series/[id]/cancel — pro:bookings:write ceiling', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  function makeRequest(): Request {
    return new Request('http://localhost/api/v1/pro/booking-series/series_1/cancel', {
      method: 'POST',
