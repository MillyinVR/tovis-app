// app/api/v1/pro/offerings/[id]/add-ons/route.ts
...
export async function GET(_req: Request, ctx: RouteContext) {
  try {
    ...
    console.error('GET /api/v1/pro/offerings/[id]/add-ons error', err)
...
export async function PUT(req: Request, ctx: RouteContext) {
  try {
    ...
    console.error('PUT /api/v1/pro/offerings/[id]/add-ons error', err)
    return jsonFail(500, 'Internal server error.')
  }
}