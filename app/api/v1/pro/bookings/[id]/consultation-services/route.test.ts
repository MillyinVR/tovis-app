// app/api/v1/pro/bookings/[id]/consultation-services/route.test.ts
...
function makeRequest(): Request {
  return new Request(
    'http://localhost/api/v1/pro/bookings/booking_1/consultation-services',
    {
      method: 'GET',
    },
  )
...
describe('app/api/v1/pro/bookings/[id]/consultation-services/route.ts', () => {
  beforeEach(() => {
    vi.resetAllMocks()
  ...
  it('logs unexpected errors through safe logging helpers and returns 500', async () => {
    ...
    try {
      ...
      expect(mocks.safeLogMeta).toHaveBeenCalledWith({
        route: 'GET /api/v1/pro/bookings/[id]/consultation-services',
      })

      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'GET /api/v1/pro/bookings/[id]/consultation-services error',
        {
          error: {
            name: 'Error',
            message: 'db boom',
