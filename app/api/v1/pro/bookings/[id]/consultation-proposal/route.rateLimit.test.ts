...
describe('POST /api/v1/pro/bookings/[id]/consultation-proposal — pro:bookings:write ceiling', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  function makeRequest(): Request {
    return new Request('http://localhost/api/v1/pro/bookings/booking_1/consultation-proposal', {
      method: 'POST',
