// app/api/v1/pro/bookings/[id]/final-review/route.test.ts
...
const IDEMPOTENCY_ROUTE = 'POST /api/v1/pro/bookings/[id]/final-review'
...
vi.mock('@/lib/idempotency', () => ({
  ...
  IDEMPOTENCY_ROUTES: {
    PRO_BOOKING_FINAL_REVIEW:
      'POST /api/v1/pro/bookings/[id]/final-review',
  },
}))
...
function makeRequest(args?: {
  ...
  return new Request(
    'http://localhost/api/v1/pro/bookings/booking_1/final-review',
    {
      method: 'POST',
      headers: {
        'content-type': 'application/json',
...
describe('app/api/v1/pro/bookings/[id]/final-review/route.ts POST', () => {
  beforeEach(() => {
    vi.clearAllMocks()
