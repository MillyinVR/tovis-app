// app/api/v1/pro/bookings/[id]/cancel/route.test.ts
...
const IDEMPOTENCY_ROUTE = 'PATCH /api/v1/pro/bookings/[id]/cancel'
...
function makeRequest(
  ...
  return new Request('http://localhost/api/v1/pro/bookings/booking_1/cancel', {
    method: 'PATCH',
    headers,
...
describe('app/api/v1/pro/bookings/[id]/cancel/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('uses default reason when body is not an object', async () => {
    const req = new Request(
      'http://localhost/api/v1/pro/bookings/booking_1/cancel',
      {
        method: 'PATCH',
        headers: {
