...
function makeRequest(args?: {
  ...
  return new Request(
    'http://localhost/api/v1/pro/bookings/booking_1/consultation/in-person-decision',
    {
      method: 'POST',
      headers: {
        'content-type': 'application/json',
...
describe('app/api/v1/pro/bookings/[id]/consultation/in-person-decision/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
