// app/api/v1/pro/bookings/[id]/consultation/in-person-decision/route.ts
import {
  jsonFail,
  jsonOk,
  pickString,
...
async function failStartedIdempotency(
  ...
  await failStartedRouteIdempotency({
    ...
    console.error(
      'POST /api/v1/pro/bookings/[id]/consultation/in-person-decision idempotency failure update error:',
      failError,
    )
  })
}
...
export async function POST(req: Request, ctx: RouteContext) {
  ...
  try {
    ...
    console.error(
      'POST /api/v1/pro/bookings/[id]/consultation/in-person-decision error',
      error,
    )
    captureBookingException({
      error,
      route: 'POST /api/v1/pro/bookings/[id]/consultation/in-person-decision',
    })
