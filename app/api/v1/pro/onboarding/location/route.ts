// app/api/v1/pro/onboarding/location/route.ts
...
export async function POST(req: Request) {
  try {
      ...
      const created = await prisma.$transaction(async (tx) => {
        ...
        const createdLocation = await tx.professionalLocation.create({
          data: {
            ...
            // Publishing/bookability must go through /api/v1/pro/schedule/publish.
            isBookable: false,
    ...
    console.error('POST /api/v1/pro/onboarding/location error', error)
