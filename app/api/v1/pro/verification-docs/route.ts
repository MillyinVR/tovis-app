// app/api/v1/pro/verification-docs/route.ts
...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      console.error('POST /api/v1/pro/verification-docs admin notify error', notifyError)
    }
    ...
    console.error('POST /api/v1/pro/verification-docs error', e)
