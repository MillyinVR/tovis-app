// app/api/v1/pro/locations/[id]/mobile-base/route.ts
//
// PATCH /api/v1/pro/locations/:id/mobile-base
//
...
export async function PATCH(req: NextRequest, ctx: RouteContext) {
  try {
    ...
    console.error('PATCH /api/v1/pro/locations/[id]/mobile-base error', error)
