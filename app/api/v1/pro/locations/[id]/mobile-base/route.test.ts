// app/api/v1/pro/locations/[id]/mobile-base/route.test.ts
...
function makeRequest(body: unknown): Request {
  return new Request('http://localhost/api/v1/pro/locations/loc_123/mobile-base', {
    method: 'PATCH',
    headers: {
...
describe('PATCH /api/v1/pro/locations/[id]/mobile-base', () => {
  beforeEach(() => {
    vi.clearAllMocks()
