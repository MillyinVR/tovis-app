// app/api/v1/pro/locations/[id]/route.test.ts
...
function makePatchRequest(body: unknown): NextRequest {
  return new NextRequest('http://localhost/api/v1/pro/locations/loc_123', {
    method: 'PATCH',
    headers: {
...
describe('app/api/v1/pro/locations/[id]/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  describe('PATCH', () => {
    ...
    it('returns 500 when PATCH throws unexpectedly', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'PATCH /api/v1/pro/locations/[id] error',
        expect.any(Error),
      )
  ...
  describe('DELETE', () => {
    ...
    it('returns 500 when DELETE throws unexpectedly', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'DELETE /api/v1/pro/locations/[id] error',
        expect.any(Error),
      )
