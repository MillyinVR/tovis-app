// app/api/v1/pro/last-minute/settings/route.ts
...
export async function GET() {
  try {
    ...
    console.error('GET /api/v1/pro/last-minute/settings error', e)
...
export async function PATCH(req: Request) {
  try {
    ...
    console.error('PATCH /api/v1/pro/last-minute/settings error', e)
