// app/api/v1/pro/license/route.ts
//
...
//
// The license IMAGE is uploaded separately via /api/v1/pro/verification-docs.
...
export async function PATCH(req: Request) {
  try {
    ...
    try {
      ...
      console.error('PATCH /api/v1/pro/license admin notify error', notifyError)
    }
    ...
    console.error('PATCH /api/v1/pro/license error', error)
