// app/api/v1/auth/password-reset/request/route.test.ts
...
function makeRequest(
  ...
  return new Request('http://localhost/api/v1/auth/password-reset/request', {
    method: 'POST',
    headers: {
...
describe('app/api/v1/auth/password-reset/request/route', () => {
  beforeEach(() => {
