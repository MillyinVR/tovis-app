...
async function getAvailability(params: Record<string, string>) {
  ...
  const req = new Request(
    `https://example.test/api/v1/availability/day?${search.toString()}`,
  )
  return GET(req)
}

describe('GET /api/v1/availability/day', () => {
  beforeEach(() => {
    vi.clearAllMocks()
...
describe('GET /api/v1/availability/day phase 2 placement', () => {
  beforeEach(() => {
    vi.clearAllMocks()
...
describe('GET /api/v1/availability/day parity regressions', () => {
  beforeEach(() => {
    vi.useFakeTimers()
