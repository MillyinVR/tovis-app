// app/api/v1/public/consultation/[token]/decision/route.test.ts

import { beforeEach, describe, expect, it, vi } from 'vitest'
import { ClientActionTokenKind, Role } from '@prisma/client'

const IDEMPOTENCY_ROUTE = 'POST /api/v1/public/consultation/[token]/decision'
const OPERATION = 'POST /api/v1/public/consultation/[token]/decision'
...
function makeRequest(args?: {
  ...
  return new Request(
    'http://localhost/api/v1/public/consultation/token_1/decision',
    {
      method: 'POST',
      headers: {
        'content-type': 'application/json',
...
describe('POST /api/v1/public/consultation/[token]/decision', () => {
  beforeEach(() => {
    vi.clearAllMocks()
