// app/api/v1/admin/look-comments/[id]/moderate/route.test.ts
...
function makeJsonRequest(body: unknown): NextRequest {
  return asNextRequest(
    new Request('http://localhost/api/v1/admin/look-comments/comment_1/moderate', {
      method: 'POST',
      headers: {
...
describe('app/api/v1/admin/look-comments/[id]/moderate/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
