...
function makeRequest(
  ...
  return new NextRequest('http://localhost/api/v1/admin/professionals/pro_1', {
    method: 'PATCH',
    headers: {
...
describe('app/api/v1/admin/professionals/[id]/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('returns 500 when the transaction throws', async () => {
    ...
    expect(consoleErrorSpy).toHaveBeenCalledWith(
      'PATCH /api/v1/admin/professionals/[id] error',
      expect.any(Error),
    )
