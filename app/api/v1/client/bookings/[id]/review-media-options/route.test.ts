// app/api/v1/client/bookings/[id]/review-media-options/route.test.ts
...
describe('app/api/v1/client/bookings/[id]/review-media-options/route.ts GET', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('returns 500 for unexpected errors', async () => {
    ...
    try {
      ...
      expect(spy).toHaveBeenCalledWith(
        'GET /api/v1/client/bookings/[id]/review-media-options error',
        expect.any(Error),
      )
    } finally {
      spy.mockRestore()
