// app/api/v1/client/bookings/[id]/checkout/products/route.test.ts
...
const IDEMPOTENCY_ROUTE =
  'POST /api/v1/client/bookings/[id]/checkout/products'
...
function makeRequest(args?: {
  ...
  return new NextRequest(
    'http://localhost/api/v1/client/bookings/booking_1/checkout/products',
    {
      method: 'POST',
      headers: {
        'content-type': 'application/json',
...
describe('app/api/v1/client/bookings/[id]/checkout/products/route.ts POST', () => {
  beforeEach(() => {
    vi.clearAllMocks()
