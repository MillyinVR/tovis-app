// app/api/v1/client/bookings/[id]/checkout/stripe-session/route.test.ts
...
function makeRequest(opts?: {
  ...
  return new NextRequest(
    'http://localhost/api/v1/client/bookings/booking_1/checkout/stripe-session',
    {
      method: 'POST',
      headers: {
...
describe('POST /api/v1/client/bookings/[id]/checkout/stripe-session', () => {
  beforeEach(() => {
    vi.clearAllMocks()
