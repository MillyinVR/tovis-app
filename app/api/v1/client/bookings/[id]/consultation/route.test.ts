// app/api/v1/client/bookings/[id]/consultation/route.test.ts
...
function makeRequest(args?: {
  ...
  return new Request(
    'http://localhost/api/v1/client/bookings/booking_1/consultation',
    {
      method: 'POST',
      headers: {
...
describe('app/api/v1/client/bookings/[id]/consultation/route.ts', () => {
  ...
  describe('GET', () => {
    ...
    it('returns 500 and logs a safe error when GET throws', async () => {
      ...
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'GET /api/v1/client/bookings/[id]/consultation error',
        {
          error: {
            name: 'Error',
            message: 'db blew up',
  ...
  describe('POST', () => {
    ...
    it('returns 500 and logs a safe error when POST throws', async () => {
      ...
      expect(mocks.safeError).toHaveBeenCalledWith(thrown)
      expect(consoleErrorSpy).toHaveBeenCalledWith(
        'POST /api/v1/client/bookings/[id]/consultation error',
        {
          error: {
            name: 'Error',
