// app/api/v1/client/bookings/[id]/share-look/route.ts
//
...
export async function POST(req: Request, ctx: RouteContext) {
  try {
    ...
    return await withRouteIdempotency<ShareLookResponseBody>(
      {
        ...
        operation: 'POST /api/v1/client/bookings/[id]/share-look',
      },
      async () => {
    ...
    console.error('POST /api/v1/client/bookings/[id]/share-look error', {
