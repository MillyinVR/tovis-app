// app/api/v1/client/reviews/[id]/media/route.test.ts
...
function makePostRequest(body: unknown): NextRequest {
  return new NextRequest('http://localhost/api/v1/client/reviews/review_1/media', {
    method: 'POST',
    headers: {
      'content-type': 'application/json',
    },
...
describe('app/api/v1/client/reviews/[id]/media/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
