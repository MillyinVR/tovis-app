// app/api/v1/client/reviews/[id]/media/[mediaId]/route.test.ts
...
function makeDeleteRequest(): NextRequest {
  return new NextRequest(
    'http://localhost/api/v1/client/reviews/review_1/media/media_1',
    {
      method: 'DELETE',
    },
  )
...
describe('app/api/v1/client/reviews/[id]/media/[mediaId]/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('returns 500, logs a safe error, and does not leak unexpected errors', async () => {
    ...
    expect(consoleErrorSpy).toHaveBeenCalledWith(
      'DELETE /api/v1/client/reviews/[id]/media/[mediaId] error',
      {
        error: {
          name: 'Error',
          message:
