// app/api/v1/client/profile/route.test.ts
...
async function patch(body: Record<string, unknown>): Promise<Res> {
  ...
  return (await PATCH(new Request('http://test/api/v1/client/profile', { method: 'PATCH' }))) as Res
}

describe('PATCH /api/v1/client/profile', () => {
