// app/api/v1/client/rebook/[token]/route.test.ts
...
function makeRequest(args?: {
  ...
  return new Request('http://localhost/api/v1/client/rebook/token_1', {
...
describe('app/api/v1/client/rebook/[token]/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
    vi.useFakeTimers()
