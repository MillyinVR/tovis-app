// app/api/v1/viral-service-requests/route.ts
...
export async function GET(req: Request) {
  try {
    ...
    console.error('GET /api/v1/viral-service-requests error', error)
...
export async function POST(req: Request) {
  try {
    ...
    console.error('POST /api/v1/viral-service-requests error', error)
