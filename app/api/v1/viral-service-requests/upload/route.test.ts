// app/api/v1/viral-service-requests/upload/route.test.ts
...
function makeJsonRequest(body: unknown): NextRequest {
  return asNextRequest(
    new Request('http://localhost/api/v1/viral-service-requests/upload', {
      method: 'POST',
      headers: {
...
describe('app/api/v1/viral-service-requests/upload/route.ts', () => {
  beforeEach(() => {
    vi.clearAllMocks()
