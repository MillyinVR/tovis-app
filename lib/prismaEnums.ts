...
export const NotificationEventKey = {
  ...
  LOOK_MEDIA_CLARIFICATION: 'LOOK_MEDIA_CLARIFICATION',
  LOOK_MEDIA_ADMIN_REVIEW: 'LOOK_MEDIA_ADMIN_REVIEW',
  ...
  CONSULT_PREP_REMINDER: 'CONSULT_PREP_REMINDER',
  CONSULT_PRO_FOLLOW_UP: 'CONSULT_PRO_FOLLOW_UP',
  ...
  CONSULT_STALLED_NUDGE: 'CONSULT_STALLED_NUDGE',
