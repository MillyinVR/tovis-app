...
export const defaultClientConsultInspirationCopy: BrandClientConsultInspirationCopy =
  {
    ...
    cards: {
      visualAreaNames: {
        ...
        "color_placement": "Where the color stands out",
        "color_dimension": "The mix of light and dark",
      },
      visualSummaryClauses: {
        "color_roots:keep-natural": "want to keep your natural root color",
        "color_roots:change-base": "want to explore changing your root color",
        "color_roots:not-sure": "want help choosing your root color",
        "color_root_change:lighter": "want your own root color lighter",
        "color_root_change:darker": "want your own root color darker",
        "color_root_change:not-sure": "want to see root color options with your professional",
        "color_root_blend:closer-to-roots": "want the brightness closer to your roots than in this picture",
        "color_root_blend:farther-from-roots": "want more dark color near your scalp",
        "color_root_blend:soft-blend": "want a gradual change from dark to light near your scalp",
        "color_root_blend:not-sure": "want help deciding where the brightness should start",
        "color_lightness:lighter": "want the light pieces lighter than this picture",
        "color_lightness:darker": "want the light pieces less light than this picture",
        "color_lightness:not-sure": "want help deciding how light to go",
        "color_tone:different-tone": "want a different shade, still to be chosen visually",
        "color_tone:not-sure": "want to compare shades visually with your professional",
        "color_placement:softer": "want the color in this area to stand out less",
        "color_placement:bolder": "want the color in this area to stand out more",
        "color_placement:different-placement": "want to choose a different area for the color",
        "color_placement:not-sure": "want help choosing where the color goes",
        "color_dimension:softer": "want a softer mix of light and dark",
        "color_dimension:more-contrast": "want more contrast between light and dark",
        "color_dimension:not-sure": "want help choosing the mix of light and dark",
      },
      ...
      prompts: {
        "color_roots": "For the hair next to your scalp (your roots), do you like how light or dark this area is?",
        ...
        "color_tone": "Is it this particular shade you like, or would you change the shade?",
        "color_placement": "How do you feel about where the color stands out in this part?",
        "color_dimension": "How do you feel about the mix of light and dark here?",
      ...
      optionLabels: {
        ...
        "color_root_change:lighter": "Lighter than my roots are now",
        "color_root_change:darker": "Darker than my roots are now",
        "color_root_change:not-sure": "I need to see options with my professional",
        "color_root_blend:match-reference": "Like this part of the picture",
        "color_root_blend:closer-to-roots": "Closer to my roots",
        "color_root_blend:farther-from-roots": "Keep more dark color near my scalp",
        "color_root_blend:soft-blend": "A gradual change from dark to light near my scalp",
        "color_root_blend:not-sure": "Help me decide",
        "color_lightness:match-reference": "This lightness is what I like",
        "color_lightness:lighter": "I would like it lighter",
        "color_lightness:darker": "A little less light for me",
        "color_lightness:not-sure": "Help me decide",
        "color_tone:match-reference": "I like this shade",
        "color_tone:different-tone": "I like the idea, but want a different shade",
        "color_tone:not-sure": "I need to see options with my professional",
        "color_placement:match-reference": "I like it here, like this",
        "color_placement:softer": "Make this area softer",
        "color_placement:bolder": "Make this area stand out more",
        "color_placement:different-placement": "I want it in a different area",
        "color_placement:not-sure": "Help me decide",
        "color_dimension:match-reference": "I like this mix",
        "color_dimension:softer": "Blend the differences more softly",
        "color_dimension:more-contrast": "Make the light and dark stand out more",
        "color_dimension:not-sure": "Help me decide",

        'spark_focus:the-color': 'The color',
        'spark_focus:the-cut': 'The cut',
        'spark_focus:the-layers': 'The shorter and longer pieces (layers)',
        'spark_focus:the-movement': 'How the hair falls and moves',
        'spark_focus:the-length': 'The length',
        'spark_focus:the-fullness': 'How thick and full it looks',
        ...
        'keep_as_is:my-natural-roots': 'My natural color next to my scalp',
        'keep_as_is:my-natural-texture': 'How my hair dries naturally',
      ...
      attributeNames: {
        ...
        'technique:DOUBLE_PROCESS':
          'This is hair made lighter first, then given its final shade — two steps rather than one.',
        ...
        'dimension:SUBTLE': 'This is how much light and dark it has — just a small difference between the two.',
      ...
      startingPoint: {
        toneNames: {
          ASHY: 'gray or silvery',
          NEUTRAL: 'neither golden nor silvery',
          GOLDEN: 'golden',
          COPPER: 'coppery',
          RED: 'red',
          MIXED: 'mixed',
        },
        withLevelAndTone: 'your {level} hair with a {tone} shade',
        levelOnly: 'your {level} hair',
        toneOnly: 'your {tone} hair',
      },
      ...
      attributeShortNames: {
        ...
        'technique:DOUBLE_PROCESS': 'color made lighter, then given its final shade',
        ...
        'dimension:SUBTLE': 'small difference between light and dark',
      ...
      // filling the gap.
      unsureClauses: {
        'baseLevel': 'The photo doesn’t clearly show how dark the hair is near the scalp.',
        'lightestLevel': 'The photo doesn’t clearly show how light the brightest pieces are.',
        'tone': 'The photo doesn’t clearly show whether the shade looks golden, reddish, or silvery.',
        ...
        'finish': 'The photo doesn’t clearly show how shiny the hair is.',
      ...
      sparkClauses: {
        ...
        'the-layers': 'like the shorter and longer pieces',
        'the-movement': 'like how the hair falls and moves',
        'the-length': 'like the length in the picture',
        'the-fullness': 'like how thick and full it looks',
      ...
      keepClauses: {
        ...
        'my-natural-roots': 'want to keep your natural color next to your scalp',
        'my-natural-texture': 'want to keep how your hair dries naturally',
