...
- generic [active] [ref=e1]:
    ...
    - main [ref=e4]:
        ...
        - generic [ref=e19]:
          ...
          - generic [ref=e22]:
            - link "Message" [ref=e23] [cursor=pointer]:
              - /url: /messages/start?contextType=PRO_PROFILE&contextId=cmncu2lst0004tzfkkyl2nhew
      ...
      - navigation [ref=e35]:
        - link "Portfolio" [ref=e36] [cursor=pointer]:
          - /url: /professionals/cmncu2lst0004tzfkkyl2nhew
        - link "Services" [ref=e37] [cursor=pointer]:
          - /url: /professionals/cmncu2lst0004tzfkkyl2nhew?tab=services
        - link "Reviews" [ref=e38] [cursor=pointer]:
          - /url: /professionals/cmncu2lst0004tzfkkyl2nhew?tab=reviews
      - generic [ref=e39]:
  ...
  - generic [ref=e89]:
    ...
    - dialog [ref=e91]:
      ...
      - generic [ref=e123]:
        - button "Continue to add-ons" [disabled] [ref=e124]
        - generic [ref=e125]: No charge yet. The pro confirms next.
```